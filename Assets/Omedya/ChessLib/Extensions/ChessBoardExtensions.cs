...
namespace Omedya.ChessLib.Extensions
{
    ...
    {
        internal static bool IsOccupied(this ChessBoard board, ChessSquare square)
        {
            return board.GetPiece(square) is not null;
        }
        internal static bool TryGetOccupantTeam(this ChessBoard board, ChessSquare square, out ChessTeam team)
        {
